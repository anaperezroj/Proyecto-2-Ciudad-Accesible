...
import { login, signUp, signUpAvatar } from './authService';
...
// const publicRoutes = ['/users/login', '/users/account'];
...
axios.interceptors.response.use(
  ...
  function (error) {
    ...
    if (
      ...
      // Y la url anterior no es el login (sino se piden los post y no da tiempo a setear el localStorage ya que no es inmediato)
...
export { login, signUp, signUpAvatar };
